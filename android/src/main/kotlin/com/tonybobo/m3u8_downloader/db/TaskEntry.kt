...
object TaskEntry : BaseColumns {
    ...
    const val COLUMN_NAME_MINE_TYPE = "mime_type"
    ...
    const val COLUMN_NAME_SAVE_IN_PUBLIC_STORAGE= "save_in_public_storage"
    const val COLUMN_NAME_ALLOW_CELLULAR = "allow_cellular"
}
